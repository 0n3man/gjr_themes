		...
		<div id="wrapper">
				...
				<div id="sidebar-inner">
					<div id="sidebar-padding">
						...
						<div class="sidebar-divide">
							...
							<ul class="image-info">	
								<?php if ((strlen(getImageDate()) > 0) || (zp_loggedin())) {?><li class="date"><?php printImageDate('','',null,true); ?></li><?php } ?>
								<?php if ((strlen(getImageDesc()) > 0) || (zp_loggedin())) {?><li class="desc"><?php printImageDesc(true); ?></li><?php } ?>
			...
			<div id="page">
				<div id="image-wrap" class="box">
					<div id="full-image">
						<?php if (($zpmas_finallink)=='colorbox') { ?><a class="zpmas-cb" href="<?php if ($zpmas_cbtarget) { echo htmlspecialchars(getDefaultSizedImage()); } else { echo htmlspecialchars(getUnprotectedImageURL()); } ?>" title="<?php echo getBareImageTitle();?>"><?php printDefaultSizedImage(getAnnotatedImageTitle()); ?></a><?php } ?>
						<?php if (($zpmas_finallink)=='nolink') { printDefaultSizedImage(getAnnotatedImageTitle()); } ?>
				...
				<div class="post"><?php printjCarouselThumbNav(3,108,108,108,108); ?></div>
